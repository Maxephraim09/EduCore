<?php
session_start();
chdir('../'); // move back to project root

require_once('db/config.php');
require_once('const/school.php');
require_once('const/check_session.php');

// 🔥 FIX: Ensure student is properly validated
if ($res != "1" || $level != "3") {
...
<div><a href="student/view_enquiries"><button class="btn btn-primary">View History</button></a></div>
</div>
...
<form method="POST" action="student/core/submit_enquiry.php" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="alt_contact" placeholder="Email or Phone">
    </div>

    <button type="submit" name="submit" value="1" class="btn btn-primary w-100">Submit Enquiry</button>
