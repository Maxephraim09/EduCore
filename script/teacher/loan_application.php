...
$message = '';
if(isset($_SESSION['loan_msg'])){
    $message = $_SESSION['loan_msg'];
    unset($_SESSION['loan_msg']);
}
...
<main class="app-content">
  <div class="app-title">
    <div>
     ...
     <div>
    <a href="teacher/view_my_loans"><button class="btn btn-primary app_btn">Loan History</button></a>
</div>
  </div>
...
<h3 class="tile-title">Apply for a Loan</h3>

<?php if($message): ?>
<div class="alert alert-info"><?php echo htmlspecialchars($message); ?></div>
<?php endif; ?>

<form class="app_frm" method="POST" autocomplete="OFF" action="teacher/core/loan_application.php">
    <div class="mb-2">
        <label class="form-label">Loan Amount</label>
        <input type="number" min="1000" class="form-control" name="loan_amount" required placeholder="Enter loan amount">
    </div>
    ...
    <button type="submit" name="submit" value="1" class="btn btn-primary app_btn">Submit Application</button>
</form>
