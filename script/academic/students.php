...
<a onclick="del('academic/core/drop_student?id=<?php echo $row[0]; ?>&img=<?php echo $row[9]; ?>', 'Delete Student?');" class="btn btn-danger btn-sm" href="javascript:void(0);">Delete</a>
</td>
...
<form enctype="multipart/form-data" action="academic/core/update_student" class="app_frm" method="POST" autocomplete="OFF">
<div class="mb-2">
