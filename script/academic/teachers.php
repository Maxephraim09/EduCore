...
<form class="app_frm" method="POST" autocomplete="OFF" action="academic/core/new_user2">
<div class="mb-2">
...
<div class="modal-body">
<form class="app_frm" method="POST" autocomplete="OFF" action="academic/core/update_user2">
<div class="mb-2">
<label class="form-label">First Name</label>
...
<div class="modal-body">
<form enctype="multipart/form-data" class="app_frm" method="POST" autocomplete="OFF" action="academic/core/import_users">
<div class="mb-3">
