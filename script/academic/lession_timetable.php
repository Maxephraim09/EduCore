...
<head>
<meta charset="utf-8">
<title>MGTechs - Lesson Timetable</title>
...
<main class="app-content">
  <div class="app-title">
    ...
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addModal">Add Lesson</button></li>
      <li class="breadcrumb-item"><button class="btn btn-success btn-sm" onclick="window.print();">Print Timetable</button></li>
    </ul>
  </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="app_frm" method="POST" action="academic/core/add_timetable">
          <?php
          try {
              $conn = new PDO("mysql:host=" . DBHost . ";dbname=" . DBName . ";charset=" . DBCharset, DBUser, DBPass);
              $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
              // Classes
              $classes = $conn->query("SELECT id, name FROM tbl_classes")->fetchAll(PDO::FETCH_ASSOC);
              // Subjects
              $subjects = $conn->query("SELECT id, name FROM tbl_subjects")->fetchAll(PDO::FETCH_ASSOC);
          ...
          <button type="submit" class="btn btn-primary app_btn">Add Lesson</button>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <div class="tile-body">
          <h3 class="tile-title">Weekly Timetable</h3>
            ...
            <table class="table table-bordered" id="timetableTable">
              ...
              try {
                  ...
                  foreach ($stmt->fetchAll(PDO::FETCH_ASSOC) as $row) {
                      ...
                      <td>{$row['subject']}</td>
                      <td>
                        <a href='admin/core/edit_timetable?id={$row['id']}' class='btn btn-warning btn-sm'>Edit</a>
                        <a href='admin/core/delete_timetable?id={$row['id']}' class='btn btn-danger btn-sm'>Delete</a>
                      </td>
                      </tr>";
                  }
              } catch (PDOException $e) {
...
$(document).ready(function() {
  ...
  // Ensure Select2 works inside modal
