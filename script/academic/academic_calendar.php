...
try {
    ...
    // Get active session
    $sessionQuery = $conn->query("SELECT id, session_name FROM tbl_sessions WHERE is_active = 1 LIMIT 1");
    $activeSession = $sessionQuery->fetch(PDO::FETCH_ASSOC);
    $currentSessionId = $activeSession ? $activeSession['id'] : null;

    // Fetch academic calendar
    $stmt = $conn->prepare("
        SELECT c.*, s.session_name 
        FROM tbl_academic_calendar c 
        LEFT JOIN tbl_sessions s ON c.session_id = s.id 
...
<head>
<title>MGTechs - Academic Caalandar</title>
<meta charset="utf-8">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">
                        Academic Calendar – <?php echo $activeSession['session_name'] ?? 'No Active Session'; ?>
                    </h4>
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addModal">+ Add Activity</button>
                </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover align-middle">
                            ...
                            <tbody>
                                <?php if ($calendar): $i = 1; foreach ($calendar as $row): 
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $days . " days (" . round($days/7, 1) . " wks)"; ?></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="academic/core/calendar_core.php?delete=<?php echo $row['id']; ?>"
                    ...
                    <button class="btn btn-success mt-3" onclick="window.print()">🖨 Print Calendar</button>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="addModal" tabindex="-1">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <form action="academic/core/calendar_core" method="POST">
        <div class="modal-header">
          <h5 class="modal-title">Add Academic Activity</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
        </div>
        <div class="modal-body">
          <input type="hidden" name="session_id" value="<?php echo $currentSessionId; ?>">
          <div class="mb-3">
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <form action="academic/core/calendar_core" method="POST">
        ...
        <div class="modal-footer">
          <button type="submit" name="update_calendar" class="btn btn-warning">Update</button>
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        </div>
      </form>
    </div>
