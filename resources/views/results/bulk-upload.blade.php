...
<div class="container-fluid">
    <div class="card mb-4">
        <div class="card-body d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
            <div>
                <h5 class="mb-2"><i class="fas fa-file-upload"></i> Bulk Upload Results</h5>
                <p class="mb-0 text-muted">Upload results for multiple students in a single exam.</p>
            </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('results.bulk-upload.store', $exam->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Exam</label>
                        <input type="text" readonly class="form-control" value="{{ $exam->term }} ({{ $exam->academic_year }})">
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        @error('results_file')<div class="text-danger small">{{ $message }}</div>@enderror
                    </div>
                </div>
